...
- [`android/`](android/) — overlay `12.10.1-a-gram.10` для официального Telegram Android.
...
- Ghost Mode (best effort): подавление read/story/typing/online-сигналов, чтение при взаимодействии и предупреждения перед раскрывающими активность действиями;
