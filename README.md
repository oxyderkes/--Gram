...
- [`android/`](android/) — overlay `12.10.1-a-gram.14` для официального Telegram Android.
...
- отдельный сетевой режим каждого контейнера: direct, свой SOCKS5/MTProto proxy или Tor через Orbot с fail-closed kill switch;
- отдельный UnifiedPush instance/endpoint на контейнер с регистрацией Telegram Simple Push type 4 без объединения `other_uids`;
