...
public class ApplicationLoaderImpl extends ApplicationLoader {
    private static final PushListenerController.IPushListenerServiceProvider DIRECT_PUSH_PROVIDER = new PushListenerController.IPushListenerServiceProvider() {
        @Override
        ...
        public String getLogTitle() {
            return "Google-free direct push";
        }
