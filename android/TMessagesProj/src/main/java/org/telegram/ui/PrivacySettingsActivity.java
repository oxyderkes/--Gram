    ...
    private class ListAdapter extends RecyclerListView.SelectionAdapter {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                ...
                case 1:
                    ...
                    } else if (position == agramKeepDeletedInfoRow) {
                        privacyCell.setText(getString(R.string.AGramKeepDeletedInfo));
                ...
                case 2:
                    ...
                    } else if (position == agramSectionRow) {
                        headerCell.setText(getString(R.string.AGramSettingsSection));
                    }
                    break;
                case 3:
                    ...
                    if (position == secretWebpageRow) {
                        ...
                        textCheckCell.setTextAndCheck(getString(R.string.AGramKeepDeletedMessages), getMessagesController().isKeepDeletedMessagesEnabled(), false);
                    }
                    break;
                case 5:
        ...
        public int getItemViewType(int position) {
            if (position == passportRow || position == lastSeenRow || position == phoneNumberRow ||
                ...
                return 1;
            } else if (position == securitySectionRow || position == advancedSectionRow || position == privacySectionRow || position == agramSectionRow || position == secretSectionRow || position == botsSectionRow || position == contactsSectionRow || position == newChatsHeaderRow) {
                return 2;
            } else if (position == secretWebpageRow || position == contactsSyncRow || position == contactsSuggestRow || position == newChatsRow || position == agramKeepDeletedRow) {
                return 3;
