...
public class MessageCustomParamsHelper {
    ...
    public static void copyParams(TLRPC.Message fromMessage, TLRPC.Message toMessage) {
        ...
        toMessage.agramDeletedOnServer = fromMessage.agramDeletedOnServer;
    }
    ...
    private static class Params_v1 extends TLObject {
        ...
        private Params_v1(TLRPC.Message message) {
            ...
            flags = setFlag(flags, FLAG_14, message.agramDeletedOnServer);
        }
        ...
        public void readParams(InputSerializedData stream, boolean exception) {
            ...
            message.agramDeletedOnServer = hasFlag(flags, FLAG_14);
        }
