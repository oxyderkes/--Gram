...
struct Settings {
	...
	MTPInputPeer singlePeerSearchFrom = MTP_inputPeerEmpty();
	PeerId singlePeerSearchFromId = 0;
	QString singlePeerSearchFromName;
	QString singlePeerSearchFromUsername;
	...
	bool onlySinglePeerFromUser() const {
		return onlySinglePeer()
			&& singlePeerSearchFrom.type() != mtpc_inputPeerEmpty;
	}
