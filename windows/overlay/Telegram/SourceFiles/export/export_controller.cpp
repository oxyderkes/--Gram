...
PasswordCheckState FilteredInitialState(
		const MTPInputPeer &peer,
		const MTPInputPeer &searchFrom,
		PeerId searchFromId,
		const QString &searchFromName,
		const QString &searchFromUsername) {
	auto state = PasswordCheckState();
	state.checked = false;
	state.requesting = false;
	state.singlePeer = peer;
	state.singlePeerSearchFrom = searchFrom;
	state.singlePeerSearchFromId = searchFromId;
	state.singlePeerSearchFromName = searchFromName;
	state.singlePeerSearchFromUsername = searchFromUsername;
	return state;
}
