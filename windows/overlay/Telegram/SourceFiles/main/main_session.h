...
public:
	...
	[[nodiscard]] SecretChats::Manager &secretChats() const {
		return *_secretChats;
	}
...
private:
	...
	const std::unique_ptr<SecretChats::Manager> _secretChats;
	...
	bool _heavyLocalDataStarted = false;
