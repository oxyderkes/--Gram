...
public:
	...
	void markAgramDeletedOnServer();
	[[nodiscard]] bool agramDeletedOnServer() const {
		return _agramDeletedOnServer;
	}
	void markAgramSecretMediaLocal();
	[[nodiscard]] bool agramSecretMediaLocal() const {
		return _agramSecretMediaLocal;
	}
...
private:
	...
	uint32 _agramDeletedOnServer : 1 = 0;
	uint32 _agramSecretMediaLocal : 1 = 0;
