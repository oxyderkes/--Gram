...
#else // OS_WIN_STORE
const WCHAR AppUserModelIdBase[] = L"Agram.Desktop";
#endif // OS_WIN_STORE
...
void CleanupShortcut() {
	...
	QString path = systemShortcutPath() + u"alpha-Gram.lnk"_q;
...
bool checkInstalled(QString path = {}) {
	...
	const auto installed = u"ά‑Gram/alpha-Gram.lnk"_q;
