...
History *Entry::asHistory() {
	if (_flags & Flag::IsHistory) {
		return static_cast<History*>(this);
	} else if (_flags & Flag::IsSecretChat) {
		return static_cast<SecretChats::Entry*>(this)->history();
	}
	return nullptr;
}
...
Data::Thread *Entry::asThread() {
	if (_flags & Flag::IsThread) {
		return static_cast<Data::Thread*>(this);
	} else if (_flags & Flag::IsSecretChat) {
		return static_cast<SecretChats::Entry*>(this)->history();
	}
	return nullptr;
...
SecretChats::Entry *Entry::asSecretChat() {
	return (_flags & Flag::IsSecretChat)
		? static_cast<SecretChats::Entry*>(this)
		: nullptr;
}
...
const SecretChats::Entry *Entry::asSecretChat() const {
